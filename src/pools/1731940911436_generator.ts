...
import { tts,
run,
changeKeyName } from "symmetric-parser";
const template = {
'firsty1/randomParser01': ({randomParser01})=>`${run(randomParser01, 'randomParser01')}`,
...
// @ts-ignore
const result = changeKeyName(template, "key1", "key2");
