import { nameProperty } from "./template-pool";
import { tts,
run,
orderedParse } from "symmetric-parser";
const template = {
'968b1d77af_firsty.tsx/commandSend01,commandSend02': ({commandSend01, commandSend02})=>`import { cloneDeep, difference, last, uniqueId } from "lodash";
...
// @ts-ignore
const result = orderedParse(template, [nameProperty]);
